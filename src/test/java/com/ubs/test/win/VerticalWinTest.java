...
public class VerticalWinTest extends Connect4Tests {
    ...
    @Test
    public void verticalWinTest() throws Exception {
        GameController gameController = new GameController(7, 6, 4);
        gameController.initGame(TestPlayer.TESTVERTICALWINPLAYER1, TestPlayer.TESTVERTICALWINPLAYER2);
